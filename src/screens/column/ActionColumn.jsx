...
import PortalSelectModal from '../../modal/PortalSelectModal'
                        ...
                        <div className="space-y-8 sm:space-y-0 sm:flex sm:justify-between sm:items-center xl:block xl:space-y-8">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="space-y-1">
                                    <div className="text-xl font-medium text-gray-900"> {authInfo.username} </div>
                                    <a href="#" className="group flex items-center space-x-2.5">
                                        ...
                                        <span className="text-sm text-gray-500 group-hover:text-gray-900 font-medium">{authInfo.email}</span>
                                    </a>
                                </div>
                            </div>
