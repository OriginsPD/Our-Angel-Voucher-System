...
const AdminTable = () => {
    const { student, indexStudents, refreshVal } = StudentApi()
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {/* {
                                    student.map((items) => {
                                        return (
                                            <tr key={items.id} className="bg-white">
                                                <td className="max-w-0 w-full px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    <div className="flex">
                                                        <a href="#" className="group inline-flex space-x-2 truncate text-sm">
                                                            ...
                                                            <p className="text-gray-500 truncate group-hover:text-gray-900">{items.first_name} {items.last_name}</p>
                                                        </a>
                                                    </div>
                                                </td>
                                                ...
                                                <td className="hidden px-6 py-4 whitespace-nowrap text-sm text-gray-500 md:block">
                                                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 capitalize"> {(items.registered_status) ? 'Registered' : 'Pending'} </span>
                                                </td>
                                                <td className="px-6 py-4 text-right whitespace-nowrap text-sm text-gray-500">
